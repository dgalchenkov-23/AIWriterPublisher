...
namespace AIWriterPublisher.Api.Services
{
    ...
    {
        public async Task<string> GenerateImageAsync(EngineeringSpecDto technicalPrompt, TechnicalSpecDto artArchitectorSpec, string aspectRatio = "2:3", string analysisModel = null)
        {
